...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView mTextViewOpinion0;
    private TextView mTextViewOpinion1;
    private TextView mTextViewOpinion2;
    private TextView mTextViewOpinion3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextViewOpinion0 = findViewById(R.id.textViewOpinion0);
        mTextViewOpinion1 = findViewById(R.id.textViewOpinion1);
        mTextViewOpinion2 = findViewById(R.id.textViewOpinion2);
        mTextViewOpinion3 = findViewById(R.id.textViewOpinion3);

        options.add(mTextViewOpinion0);
        options.add(mTextViewOpinion1);
        options.add(mTextViewOpinion2);
        options.add(mTextViewOpinion3);
        playNext();
        CountDownTimer timer = new CountDownTimer(20000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if (millisUntilFinished < 10000) {
                    mTextViewTimer.setTextColor(getResources().getColor(android.R.color.holo_red_light));
                }
            }
